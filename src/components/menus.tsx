...
import { MenuCategory } from "../types/privateClientsTypes"; // import your type

interface MenusProps {
    data: MenuCategory[];
}

const Menus: FC<MenusProps> = ({ data }) => {
    return (
        <div className="w-full shadow-md">
            <div className="w-[1260px] m-auto h-[60px] flex">
                ...
                <div className="w-36 group transform pl-[84px] hover:pl-0 h-[60px] hover:bg-[#86D2DA] transition duration-800 cursor-pointer relative -right-[80px]">
                    ...
                    <p className="-mt-[60px] pt-5 hidden group-hover:block ml-12 bg-[#86D2DA] w-24 h-full transition duration-800">
                        Վճարումներ
                    </p>
                </div>
            </div>
